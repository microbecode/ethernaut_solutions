...
# Local ethernaut
ETHERNAUT=0x72f3aa9b5C406852E21781346af4D84B423Cd54A

#forge create ./src/GatekeeperOne/GatekeeperOneSolution.sol:GatekeeperOneSolution -i --rpc-url $RPC_URL --private-key $GOERLI_PRIVATE_KEY
# aa = 170 tai 253 = 595
